            ...
            <div class="card term-card mb-0">
                <div class="card-body p-5">
                    <div class="row">
                        <div class="col-lg-12">
1. Introduction
Welcome to Daltonus Store. By accessing or using our website, you agree to comply with and be bound by the following terms and conditions. Please read them carefully.

<br>
<br>

2. Account Registration: You may need to create an account to access certain features. You are responsible for maintaining the confidentiality of your account information and for all activities that occur under your account.

<br>
<br>

3. Order Acceptance: All orders are subject to acceptance and availability. We reserve the right to refuse or cancel any order for any reason.

<br>
<br>

4. Pricing: Prices are subject to change without notice. The price you pay will be the price displayed at the time you place your order.

<br>
<br>

5. Shipping: We will ship products according to the shipping option selected at checkout. Shipping times may vary based on your location.

<br>
<br>

6. Delivery: Delivery times are estimates and not guaranteed. We are not responsible for any delays in delivery.

<br>
<br>

7. Returns: You may return products within 30 days of delivery for a full refund, provided the products are in their original condition.

<br>
<br>

8.  Refunds: Refunds will be issued to the original payment method within 3 days of receiving the returned products.
